...
""")
        ...
        with patch.object(sys, "argv", ["kpyx", "build", str(config_path), "-o", str(output_path)]):
            main()
...
""")
        ...
        captured = capsys.readouterr()
        assert "New file would be created" in captured.out or "Changes for" in captured.out
